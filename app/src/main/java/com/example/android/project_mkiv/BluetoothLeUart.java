...
/**
 * Created by Jewrion on 11/15/2017.
 */
...
public class BluetoothLeUart extends BluetoothGattCallback implements BluetoothAdapter.LeScanCallback{
    ...
    public BluetoothLeUart(Context context) {
        ...
        Log.d(TAG, "BluetoothLeUart constructor started");
    ...
    public String getDeviceInfo() {
        ...
        Log.d(TAG, "Device info = " + sb.toString());
    ...
    public void send(byte[] data) {
        ...
        Log.d(TAG, "sending data by the byte to the device");
    ...
    public void send(String data) {
        Log.d(TAG, "send w/ string parameter is called");
        if (data != null && !data.isEmpty()) {

            Log.d(TAG, "there is ddata in the string");
